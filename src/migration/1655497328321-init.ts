...
export class init1655497328321 implements MigrationInterface {
    name = 'init1655497328321'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "finance" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created" datetime NOT NULL DEFAULT (datetime('now')), "updated" datetime NOT NULL DEFAULT (datetime('now')), "value" double NOT NULL, "description" varchar NOT NULL, "referenceId" integer, "datetime" datetime NOT NULL, "typeId" integer NOT NULL, "sourceId" integer NOT NULL, "destinationId" integer)`);
        await queryRunner.query(`CREATE TABLE "history" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created" datetime NOT NULL DEFAULT (datetime('now')), "updated" datetime NOT NULL DEFAULT (datetime('now')), "earned" double, "spent" double, "current" double, "datetime" datetime NOT NULL, "sourceId" integer NOT NULL)`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_finance"("id", "created", "updated", "value", "description", "referenceId", "datetime", "typeId", "sourceId", "destinationId") SELECT "id", "created", "updated", "value", "description", "referenceId", "datetime", "typeId", "sourceId", "destinationId" FROM "finance"`);
        await queryRunner.query(`DROP TABLE "finance"`);
        await queryRunner.query(`ALTER TABLE "temporary_finance" RENAME TO "finance"`);
        await queryRunner.query(`CREATE TABLE "temporary_history" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created" datetime NOT NULL DEFAULT (datetime('now')), "updated" datetime NOT NULL DEFAULT (datetime('now')), "earned" double, "spent" double, "current" double, "datetime" datetime NOT NULL, "sourceId" integer NOT NULL, CONSTRAINT "FK_7a25496d0f369261e67a2a36fe9" FOREIGN KEY ("sourceId") REFERENCES "account" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_history"("id", "created", "updated", "earned", "spent", "current", "datetime", "sourceId") SELECT "id", "created", "updated", "earned", "spent", "current", "datetime", "sourceId" FROM "history"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "history" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created" datetime NOT NULL DEFAULT (datetime('now')), "updated" datetime NOT NULL DEFAULT (datetime('now')), "earned" double, "spent" double, "current" double, "datetime" datetime NOT NULL, "sourceId" integer NOT NULL)`);
        await queryRunner.query(`INSERT INTO "history"("id", "created", "updated", "earned", "spent", "current", "datetime", "sourceId") SELECT "id", "created", "updated", "earned", "spent", "current", "datetime", "sourceId" FROM "temporary_history"`);
        ...
        await queryRunner.query(`CREATE TABLE "finance" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created" datetime NOT NULL DEFAULT (datetime('now')), "updated" datetime NOT NULL DEFAULT (datetime('now')), "value" double NOT NULL, "description" varchar NOT NULL, "referenceId" integer, "datetime" datetime NOT NULL, "typeId" integer NOT NULL, "sourceId" integer NOT NULL, "destinationId" integer)`);
        await queryRunner.query(`INSERT INTO "finance"("id", "created", "updated", "value", "description", "referenceId", "datetime", "typeId", "sourceId", "destinationId") SELECT "id", "created", "updated", "value", "description", "referenceId", "datetime", "typeId", "sourceId", "destinationId" FROM "temporary_finance"`);
